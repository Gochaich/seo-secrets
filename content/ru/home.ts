...
export const benefits: Benefit[] = [
  {
    ...
    icon: `${TILDA}/tild3137-3461-4361-a565-346433343736/vector.svg`,
  },
  {
    ...
    icon: `${TILDA}/tild6231-3564-4733-b034-313930373435/vector.svg`,
  },
  {
    ...
    icon: `${TILDA}/tild3937-3162-4031-a333-633739323335/vector.svg`,
  },
  {
    ...
    icon: `${TILDA}/tild3932-6633-4333-a634-633766363961/vector.svg`,
  },
  {
    title: 'Конверсия (CRO)',
    text: [
    ...
    icon: `${TILDA}/tild6137-3831-4265-a266-656663313434/vector.svg`,
  },
  {
    ...
    icon: `${TILDA}/tild3763-3664-4565-a365-653564666365/vector.svg`,
  },
];
...
export const founder = {
  ...
  facts: [
    '300+ успешно реализованных SEO-проектов',
    '50 млн пользователей посещают сайты клиентов ежемесячно',
    'Собственная программа обучения SEO PRO',
    'Фокус — казахстанские проекты, англоязычное и международное SEO',
  ],
} as const;
...
export const process: ProcessStep[] = [
  {
    ...
    paragraphs: [
      'На первом этапе мы знакомимся с вами, бизнесом и ключевыми целями проекта. Наша цель — на 100% понять нишу проекта, аудиторию и конкурентов, в которой вы работаете.',
  ...
  },
  {
    ...
    paragraphs: [
      'Для любого нашего проекта 80% успеха — это правильная SEO/AI Visibility стратегия. Мы проводим аудит проекта по 200 основным SEO-факторам, делящимся на 7 направлений:',
    ],
    list: {
      ordered: true,
      items: [
  ...
  },
  {
    ...
    paragraphs: [
      'После согласования и презентации полной SEO-стратегии мы переходим к практической реализации. На этом этапе команда SEO Secrets формирует чёткий план действий на первый месяц и подключает ключевые инструменты для отслеживания прогресса по всем важным метрикам, влияющим на видимость и прибыль бизнеса.',
  ...
  },
  {
    ...
    paragraphs: [
      'Мы уважаем прозрачность и честность в работе. Со второго месяца клиент получает детализированные ежемесячные отчёты, в которых отражаются:',
    ],
    list: {
      ordered: false,
      items: [
        'цифры: рост позиций в Google/Yandex, упоминания в ChatGPT и Google AI Overview;',
        'динамика роста позиций, трафика и лидов для бизнеса;',
